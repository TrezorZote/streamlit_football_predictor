...
la_liga_team_stats = {
    ...
    "Elche":              [1.67, 1.15, 1.08, 2.00],
    "Osasuna":            [1.77, 0.67, 1.18, 1.25],
    "Real Sociedad":      [1.85, 1.19, 1.42, 1.47], 
...
bundesliga3_team_stats = {
    ...
    "Stuttgart 2":  [1.38, 1.07, 1.46, 1.80],
    "Hoffenheim 2": [1.65, 1.55, 1.42, 2.00],
    "TSV Havelse":        [1.20, 0.95, 1.35, 1.50],
    "Ulm":                [1.40, 1.05, 1.00, 1.25],
    "VfL Osnabruck":      [1.35, 2.00, 0.60, 1.10],
...
turkish_super_lig_stats = {
    ...
    "Besiktas":          [1.75, 1.80, 1.30, 1.30],
    "Istanbul Basaksehir":[1.70, 1.75, 1.30, 0.87],
